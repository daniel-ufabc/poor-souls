\renewcommand{\thechapterdisplay}{Véspera do primeiro dia}
\renewcommand{\thechapterrunner}{Introdução}
\chapter[Véspera do primeiro dia --- Introdução]{Introdução}
...
\begin{quote}
\textit{\textit{Quando quero muito obter uma graça, eu recorro a essas almas sofredoras, afim de que elas apresentem meu pedido ao Senhor, e a graça é sempre alcançada.}}
\end{quote}
...
\begin{quote}
\textit{\textit{Se soubéssemos quão grande é o poder das almas do Purgatório e quantas graças podemos obter de Deus por sua intercessão, elas não seriam tão esquecidas! Rezemos bem por elas, para que elas rezem muito por nós.}}
\end{quote}
