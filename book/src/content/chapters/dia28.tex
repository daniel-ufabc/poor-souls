...
\renewcommand{\thechapterrunner}{Como podemos evitar o Purgatório}
\chapter[Vigésimo oitavo dia --- Como podemos evitar o Purgatório]{Como podemos evitar o Purgatório}
