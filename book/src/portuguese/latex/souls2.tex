\documentclass[11pt,twoside,openright,twocolumn]{book}
...
% Chapter formatting - spans both columns
...
% Title page
\begin{titlepage}
    \onecolumn  % Force single column for title page
    \centering
    \vspace*{2cm}
...
% Table of contents
\onecolumn  % Single column for TOC
\tableofcontents
\cleardoublepage
